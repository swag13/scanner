...
public class ArchitectureAnalyzer {
     ...
     */
    public static List<RuleViolation> analyze(String compiledDir, String basePackage) {
        List<RuleViolation> violations = new ArrayList<>();

        try {
            // 1. Add ArchUnit rule results
            List<RuleViolation> archViolations = ArchRuleChecker.check(compiledDir, basePackage);
